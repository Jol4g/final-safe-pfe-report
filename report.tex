...
\providecommand{\keywordss}[1]{\textbf{\textit{React Native, TypeScript, Redux, Realm, Azure, REST, Jest, ---}} #1}
...
%\vspace{1cm}%A tous ceux qui me sont chers...
